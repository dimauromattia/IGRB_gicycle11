...
The contribution of blazars, which are traditionally divided into BL Lacertae (BL Lacs) and Flat Spectrum Radio Quasars (FSRQs),  has a relative uncertainty of about $30\%$ while the contributions of SFG and MAGN at known to $40$ and $50\%$, respectively.
...
astrophysical components at the 20\% level would make this particular probe highly competative with 
other searches. \FIXME{Do we have a reference for this claim?  Also, I think it would be clearer if we framed this in terms 
of the uncertainty on the  unaccounted for fraction of the IGRB.}
...
These limits will be as good as the stacking analysis of clusters or of Milky Way Dwarf Spheroidal Galaxies. \FIXME{Do we have a reference here.}
...
The composition of the IGRB is an open problem in astrophysics.   We propose to search for possible signatures of a DM contribution over the next two years.
...
We will take the results of the stacking analysis of SFGs derived with an other program proposed at this cycle of the {\it Fermi} GI (P.I. V.S. Paliya and Co.I. M. Ajello and M.Di Mauro).  \FIXME{What happens if that other proposal isn't selected?   Don't introduce something new in the summary.}
The work performed in the previous analyses will enable us to have the most precise ever estimation of the contribution of extragalactic sources to the IGRB and will permit us to search for signatures or bounds for DM production of $\gamma$ rays.
...
The PI M. Di Mauro and CO-Is M. Ajello, V. Paliya, S. Manconi and H. Zechlin will be directly in charge of the analysis.\FIXME{If you can make the space, list what parts of the analysis people will work on.}   CO-Is E. Charles, F. Donato and S. Diegel will provide both technical and the scientific input.
